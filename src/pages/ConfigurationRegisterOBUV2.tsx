...
import styles from "./ConfigurationRegisterOBUV2.module.css";
const ConfigurationRegisterOBUV2: FunctionComponent = () => {
  return (
    <div className={styles.configurationRegisterObuV}>
      ...
      <div className={styles.configurationRegisterObuVItem} />
      ...
      <div className={styles.deliveryOrderSummary}>Delivery Order Summary</div>
      <div className={styles.itemDescription}>Item Description</div>
      <div className={styles.div}>{`:            `}</div>
      <div className={styles.ptExample1}>PT. Example 1</div>
      <div className={styles.configurationRegisterObuVInner} />
      <div className={styles.configurationRegisterObuVInner} />
      <div className={styles.configurationRegisterObuVChild1} />
      <div className={styles.configurationRegisterObuVChild1} />
      <div className={styles.december20210940}>12 December 2021 09:40</div>
      <div className={styles.num202109395393}>NUM202109395393</div>
      <div className={styles.b1234Abc}>B 1234 ABC</div>
      <div className={styles.ariefSetiawan}>Arief Setiawan</div>
      <div className={styles.dlv1234567890}>DLV1234567890</div>
...
export default ConfigurationRegisterOBUV2;
