...
import styles from "./ConfigurationOBUDeviceLis1.module.css";
const ConfigurationOBUDeviceLis1: FunctionComponent = () => {
  return (
    <div className={styles.configurationObuDeviceLis}>
      ...
      <div className={styles.rectangleParent}>
        ...
        <div className={styles.obuId}>OBU ID / Device ID</div>
...
export default ConfigurationOBUDeviceLis1;
