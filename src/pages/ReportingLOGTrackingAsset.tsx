...
import styles from "./ReportingLOGTrackingAsset.module.css";
const ReportingLOGTrackingAsset: FunctionComponent = () => {
  return (
    <div className={styles.reportingLogTrackingAsset}>
      ...
      <div className={styles.reportingLogTrackingAssetChild} />
...
export default ReportingLOGTrackingAsset;
