...
import styles from "./ConfigurationUserManagemen1.module.css";
const ConfigurationUserManagemen1: FunctionComponent = () => {
  return (
    <div className={styles.configurationUserManagemen}>
      ...
      <div className={styles.accessRoles}>Access Roles</div>
      <div className={styles.configurationUserManagemenChild9} />
      <div className={styles.configurationUserManagemenChild10} />
      <div className={styles.configurationUserManagemenChild11} />
      <div className={styles.email}>Email</div>
    </div>
  );
};

export default ConfigurationUserManagemen1;
